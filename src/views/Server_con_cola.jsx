...
function Server_con_cola() {
    ...
    const handleCalculate = (e) => {
        ...
        const lambdaPerdida = lambda * Pk; // Corrección de lambdaPerdida
        ...
        // El último valor de Fn debería ser 1, pero debido a la precisión flotante, usamos el valor calculado.
        // Pk es la Probabilidad de que haya K clientes en el sistema (el sistema esté lleno).

        // 3. ACTUALIZAR ESTADO PARA MOSTRAR RESULTADOS
        setResults({ 
            lambda: lambda.toFixed(3), // Incluir inputs para el encabezado
            mu: mu.toFixed(3),        // Incluir inputs para el encabezado
            k: k,
    ...
    return (
        // Envolvente principal: Se usa 'print:' para fondo blanco en impresión
