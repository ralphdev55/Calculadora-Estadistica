...
function Server_sin_cola() {
    ...
    const MetricCard = ({ label, value }) => (
        // Nuevo estilo de tarjeta, más claro y compacto
    ...
    return (
        // Fondo más oscuro y esquema de impresión limpio
                        ...
                        <form onSubmit={handleCalculate}>
                            <div className="space-y-4 mb-6">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="k" id="k" value={inputs.k} onChange={handleInputChange} placeholder="Ej: 10" className="w-full bg-gray-700 border border-gray-600 rounded-md p-2 text-white focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition"/>
                                </div>
                            </div>
